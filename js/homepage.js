...
function contentB(){
    if(lang == 'en'){
        ...
        model_txt.innerHTML =  
        `
            <h2 class="mb-3">唯晶科技执行长詹承翰出席「5G既出 谁与争锋」论坛与各产业专家共同分享疫后零接触商机</h2>
            <p>
        ...
        model_txt.innerHTML =  
        `
            <h2 class="mb-3">Winking CorporationのJohnny Jan CEOが「5Gの登場、誰がトップを争うか」フォーラムに出席。各業界の専門家と共に新型コロナウイルス危機下におけるゲーム業界の商機について語った。</h2>
            <p>
